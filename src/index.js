$(document).ready(function () {
  ...
  var topics = ['Hawkeye', 'Winter Soldier', 'Spiderman', 'Black Widow', 'Captain America', 'Thor', 'Hulk', 'Black Panther', 'Iron Man'];
  ...
  function renderButtons() {
    ...
    for (var i = 0; i < topics.length; i++) {
      ...
      createButtons.addClass('topic btn btn-outline-danger text-bold text-light');
